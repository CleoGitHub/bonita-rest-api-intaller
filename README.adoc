...
:short-bonita-version: 7.12
:doc-url: https://documentation.bonitasoft.com/bonita/7.12
:java-version: 1.8
= rest-api-installer

The project **rest-api-installer** is a Bonita Connector for **Bonita {short-bonita-version}**  **Community** version written in `java` language.
...
[source,bash]
----
git clone https://your.github.com/rest-api-installer.git
cd rest-api-installer/
./mwnw package
----

The build should produce a zip archive under the `target/` folder named `rest-api-installer-1.0-SNAPSHOT-all.zip`
...
Take the built artifact `rest-api-installer-1.0-SNAPSHOT-all.zip` and import it to your Bonita Studio.
